...
sphere1 = Sphere([0, -1, 3], 1, [255, 0, 0], 500)
sphere2 = Sphere([2, 0, 4], 1, [0, 0, 255], 500)
sphere3 = Sphere([-2, 0, 4], 1, [0, 255, 0], 10)
...
def traceRay (origin, direction, t_min, t_max):
	...
	return np.dot(closest_sphere.color, computeLighting(point, normal, np.multiply(-1, direction), closest_sphere.specular))
